...
public class ContainsInLine extends Contains {
    ...
    public void init(Map<String, Object> input) {
        super.init(input);
        stringIndexes = input.containsKey(INPUT_PARAMETER_2) ? (String) input.get(INPUT_PARAMETER_2) : ui.getUserInput("Which indexes?");
    ...
    private void checkFile(UserInterface ui, String element, List<Integer> indexes, Collection<Path> files, Path path) {
