...
//                return true;
//            case 2:
//                // FileFinder ff = new FileFinder("C:\\Users\\stheijde\\Repositories\\AZ\\buitenlandse-zaken\\repository-data\\development\\src\\main\\resources\\hcm-content\\content\\documents\\netherlandsandyou\\componenten\\externelinks").find("? /");
//                FileFinder ff = new FileFinder("C:\\Users\\stheijde\\Desktop\\dump").find("? /");
//                System.out.println(ff.getFoundFiles().size());
//                ff.getFoundFiles().forEach(System.out::println);
//                return true;
//            case 3:
...
//            case 5: // TODO
//                System.out.println("Which file?");
//                new FileFinder(reader.readLine()).find();
//                return true;
